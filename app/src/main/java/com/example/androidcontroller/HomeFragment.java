...
public class HomeFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnSendArenaInfo.setOnClickListener(v->{
            ...
            txtRoboStatus.setText("SEND: OBSTACLES LOCATION");
        });
...
*/
    ...
    private BroadcastReceiver robotLocationUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            try{
                ...
                txtRoboStatus.setText("RECEIVED: UPDATE ROBOT LOCATION");
            }catch (Exception e){
    ...
    private BroadcastReceiver imageRecResultReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            try{
                ...
                txtRoboStatus.setText("RECEIVED: OBSTACLES ID");
            }catch (Exception e){
    ...
    private void sendDirectionCmdIntent(String direction){
        if(robotMode == false){
            txtRoboStatus.setText("ERROR: ROBOT NOT IN MANUAL MODE");
            return;
        }
        ...
        try{
            ...
            txtRoboStatus.setText("SEND: ROBOT MOVEMENT");
        }catch (Exception e){
    ...
    private void sendModeCmdIntent(String mode){
        try{
            ...
            txtRoboStatus.setText("SEND: SET ROBOT MODE");
        }catch (Exception e){
    ...
    private void sendControlCmdIntent(String control){
        try{
            ...
            txtRoboStatus.setText("SEND: START ROBOT");
        }catch (Exception e){
